                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-select form-select-lg" id="user" name="user" required>
                    ...
                    @foreach ($peminjaman as $p)
                        @if ($p->status != 'ditolak' && $p->status != 'selesai')
                            <tr>
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="myModal{{ $p->barcode }}" tabindex="-1"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-10">
                                                                ...
                                                                @enderror --}}
                                                                        ...
                                                                        <textarea class="input-large form-control" id="message" name="message" @error('date') is-invalid @enderror required
                                                                            rows="3" placeholder="Enter a message ..."></textarea>
                                                                        @error('message')
                                                                            <div class="invalid-feedback">
                                                                                {{ $message }}
                                                                            </div>
                                                                        ...
                                                                        <div class="custom-file">
                                                                            ...
                                                                            <img class="img-preview img-fluid mt-4 mb-4 "
                                                                                id="img-preview">
                                                                            {{-- <br><br><br><br><br><br><br><br><br><br> --}}
