    ...
    var b,
                        ...
                        (this.wrapBodyInlineWithPara = function () {
                            ...
                            if (j.isInline(b)) {
                                ...
                                (a = g.last(c)),
                                    j.isInline(a) ||
                                        (a =
                                            c[c.length - 2] || b.childNodes[h]);
                            } else a = b.childNodes[h - 1];
                            var e = j.listPrev(a, j.isParaInline).reverse();
                            if (
                                ((e = e.concat(
                                    j.listNext(a.nextSibling, j.isParaInline)
                                )),
                                e.length)
                            ) {
        ...
        o = function () {
            ...
            (this.stylePara = function (b, c) {
                a.each(
                    b.nodes(j.isPara, { includeAncestor: !0 }),
                    function (b, d) {
                        a(d).css(c);
                    }
                );
                ...
                (this.current = function (c, d) {
                    ...
                    if (
                        ...
                        (g["font-italic"] = document.queryCommandState("italic")
                            ? "italic"
                            : "normal"),
                        (g["font-underline"] = document.queryCommandState(
                            "underline"
                        )
                            ? "underline"
                            : "normal"),
                        (g["font-strikethrough"] = document.queryCommandState(
                            ...
                            ? "strikethrough"
                            : "normal"),
                        (g["font-superscript"] = document.queryCommandState(
                            "superscript"
                        )
                            ? "superscript"
                            : "normal"),
                        (g["font-subscript"] = document.queryCommandState(
                            "subscript"
                        )
                            ? "subscript"
                            : "normal"),
                    ...
                    if (k && k.style["line-height"])
                        ...
                        var l =
                            parseInt(g["line-height"], 10) /
                            parseInt(g["font-size"], 10);
                        g["line-height"] = l.toFixed(1);
                    }
                    return (
                        (g.image = j.isImg(d) && d),
                        (g.anchor =
                            c.isOnAnchor() && j.ancestor(c.sc, j.isAnchor)),
            ...
            (this.insertOrderedList = function () {
                ...
                (this.wrapList = function (b, c) {
                    ...
                    (b = a.map(b, function (a) {
                        ...
                        h &&
                            (j.appendChildNodes(i, g.from(h.childNodes)),
                            j.remove(h));
                }),
                ...
                G = function (a) {
                    ...
                    d.on("mousemove", function (a) {
                        ...
                        (d = f.minHeight > 0 ? Math.max(d, f.minHeight) : d),
                            (d =
                                f.maxHeight > 0 ? Math.min(d, f.maxHeight) : d),
                            b.height(d);
                    }).one("mouseup", function () {
                        d.off("mousemove");
                    });
                ...
                (this.attach = function (a, b) {
                    b.shortcuts &&
                        ...
                        b.airMode ||
                            ...
                            b.disableResizeEditor ||
                                a.statusbar.on("mousedown", G));
            ...
            var b = function (a, b) {
                ...
                i = function (a, e) {
                    var f = function () {
                        ...
                        i = function () {
                            for (
                                var b = "", c = 0, f = e.airPopover.length;
                                f > c;
                                c++
                            ) {
                                var g = e.airPopover[c];
                                b +=
                                    '<div class="note-' + g[0] + ' btn-group">';
                ...
                r = function (a, b) {
                    ...
                    return (
                        b.extraKeys &&
                            d.push("<div " + c + ">" + q(a, b) + "</div>"),
                        '<div class="note-shortcut-row row">' +
                            d.join(
                                '</div><div class="note-shortcut-row row">'
                            ) +
                            "</div>"
                    );
                },
                ...
                t = {
                    image: function (a, b) {
                        ...
                        if (b.maximumImageFileSize) {
                            var d = Math.floor(
                                    Math.log(b.maximumImageFileSize) /
                                        Math.log(1024)
                                ),
                                e =
                                    1 *
            ...
            (this.createLayoutByAirMode = function (b, c) {
                ...
                (this.createLayoutByFrame = function (b, c) {
                    ...
                    c.height && l.height(c.height),
                        ...
                        c.placeholder &&
                            l.attr("data-placeholder", c.placeholder),
                        l.html(j.html(b)),
                        a(
            ...
            b.buttons &&
                ...
                b.langs &&
                    a.each(b.langs, function (b, c) {
                        a.summernote.lang[b] &&
                            a.extend(a.summernote.lang[b], c);
                    }),
