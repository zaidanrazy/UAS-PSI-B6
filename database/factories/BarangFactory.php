...
class BarangFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'barang' => function () {
                $barangList = [
                    "Laptop", "Mouse", "Tangga", "Helm Apd", "Rompi Apd",
                    "Sepatu Boot", "Palu", "Obeng Kembang", "Kunci Inggris", "Gergaji",
                    "Bor", "Spray Gun", "Meteran", "Sekrup", "Karter", "Pisau",
                    "Cangkul", "Kabel Utp", "Baut", "Tang", "Linggis", "Solasi",
                    "Konektor Cctv", "HT", "Tinta", "P3K", "Keyboard", "Kertas HVS", "Pulpen", "Drone",
                    "Penyedot Debu", "Sapu", "Pembersih Laptop", "Meja Pingpong", "Tikar", "Ban Mobil", "Lemari", "Meja", "Selang", "Tang Kabel", "Obeng Kotak"

                ];
                return fake()->unique()->randomElement($barangList);
            },
